...
$starthour = date("G", $startdate);
$startmins = date("i", $startdate);

$endhour = date("G", $enddate);
$endmins = date("i", $enddate);
...
echo elgg_view("input/longtext", array("name" => "description", "id" => "site-announcements-edit-description"));
echo "</div>";
...
echo elgg_view("input/dropdown", array("name" => "announcement_type", "id" => "site-announcements-type", "options_values" => $type_options, "class" => "mls"));
echo "</div>";

echo "<div>";
echo "<label for='site-announcements-access-id'>" . elgg_echo("access") . "<label>";
echo elgg_view("input/access", array("name" => "access_id", "id" => "site-announcements-access-id", "class" => "mls"));
echo "</div>";
